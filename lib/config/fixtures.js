				...
				Meteor.subscribe('listings', {
					onReady: function() {
						...
						if (count <= max) {
							...
							let json2 = require('./listings_bbb.json'); //with path
							_.each(json2.BBB_Listings, function(doc) { 
								Meteor.call('addListing', doc);
							});

							let json3 = require('./listings_bbb_onlines.json'); //with path
							_.each(json3.bbb_onlines, function(doc) { 
								Meteor.call('addListing', doc);
							});
